...
I add some mpv-like commands in key bindings.
...
``` 
Seek to the current subtitle start time, and seek to the previous subtitle start time if there is no current subtitle.
```
